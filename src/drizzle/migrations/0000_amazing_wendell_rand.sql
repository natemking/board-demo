...
--> statement-breakpoint
CREATE TABLE "user-resume-table" (
	"userId" varchar PRIMARY KEY NOT NULL,
...
ALTER TABLE "user_notifications_settings" ADD CONSTRAINT "user_notifications_settings_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user-resume-table" ADD CONSTRAINT "user-resume-table_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
